...
export default function AddPrescriptionModal({
  ...
  const [localVoiceMessages, setLocalVoiceMessages] = useState<VoiceMessage[]>(voiceMessages);
      ...
      <View style={styles.modalOverlay}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.patientCard}>
                  <View style={[styles.patientAvatar, { backgroundColor: `${themeColors.primary}20` }]}>
              ...
              <View style={styles.section}>
                ...
                {/* Repeat weeks - only show when temporaire is selected */}
                {!isChronic && (
              ...
              <View style={styles.section}>
                ...
                <View style={styles.voiceOptionsContainer}>
                  ...
                  >
                    <View style={styles.voiceOptionContent}>
                      <Ionicons
                        ...
                        size={20}
                        color={selectedVoiceMessageId === null ? themeColors.primary : "rgba(255, 255, 255, 0.6)"}
                      />
                    ...
                    >
                      ...
                      >
                        <Ionicons
                          ...
                          size={20}
                          color={selectedVoiceMessageId === voice.id ? themeColors.primary : "rgba(255, 255, 255, 0.6)"}
                        />
                  ...
                  {localVoiceMessages.length === 0 && (
                    <View style={styles.voiceEmptyState}>
                      <Text style={styles.voiceEmptyStateText}>Aucun message vocal enregistre</Text>
                    </View>
                  )}
        ...
        >
          <View style={styles.pickerOverlay}>
            <LinearGradient colors={themeColors.background} style={styles.pickerContainer}>
              <View style={styles.pickerHeader}>
                <Text style={[styles.pickerTitle, { color: themeColors.text }]}>Sélectionner un médicament</Text>
              ...
              <TextInput
                style={[styles.searchInput, { 
                  backgroundColor: themeColors.cardBg[0], 
                    ...
                    style={[
                      ...
                      { 
                        backgroundColor: selectedMedication?.id === med.id 
                          ...
                          : themeColors.cardBg[0],
                        borderColor: selectedMedication?.id === med.id 
                          ? themeColors.primary 
                          : `${themeColors.text}20`,
                        borderWidth: selectedMedication?.id === med.id ? 2 : 1,
                      }
                    ]}
                    onPress={() => handleSelectMedication(med)}
                  >
                    <View style={styles.medicationItemHeader}>
                      <Text style={[styles.medicationItemName, { color: themeColors.text }]}>{med.name}</Text>
                      <Text style={[styles.medicationItemDosage, { color: themeColors.primary }]}>{med.dosage}</Text>
                    </View>
                    <Text style={[styles.medicationItemDetails, { color: themeColors.textSecondary }]}>
                      {med.genericName} • {med.form}
                    </Text>
                    <Text style={[styles.medicationItemDescription, { color: themeColors.textSecondary }]}>{med.description}</Text>
                  </TouchableOpacity>
                ))}
              </ScrollView>
            </LinearGradient>
        ...
        >
          <View style={styles.pickerOverlay}>
            <LinearGradient colors={themeColors.background} style={styles.customMedContainer}>
              <View style={styles.pickerHeader}>
                <Text style={[styles.pickerTitle, { color: themeColors.text }]}>Nouveau Médicament</Text>
              ...
              <ScrollView style={styles.customMedForm}>
                <Text style={[styles.customMedLabel, { color: themeColors.text }]}>Nom du médicament *</Text>
                <TextInput
                ...
                <Text style={[styles.customMedLabel, { color: themeColors.text }]}>Nom générique</Text>
                <TextInput
                  style={[styles.customMedInput, { 
                    backgroundColor: themeColors.cardBg[0], 
                    borderColor: `${themeColors.primary}30`,
                ...
                <Text style={[styles.customMedLabel, { color: themeColors.text }]}>Dosage</Text>
                <TextInput
                  style={[styles.customMedInput, { 
                    backgroundColor: themeColors.cardBg[0], 
                    borderColor: `${themeColors.primary}30`,
                ...
                <Text style={[styles.customMedLabel, { color: themeColors.text }]}>Forme</Text>
                  ...
                  {['Comprimé', 'Gélule', 'Sirop', 'Injection', 'Gouttes'].map((form) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.formTypePill,
                        { 
                          backgroundColor: customMedData.form === form 
                            ? `${themeColors.primary}20` 
                            : themeColors.cardBg[0],
                          borderColor: customMedData.form === form 
                            ? themeColors.primary 
                            : `${themeColors.text}20`,
                        },
                    ...
                    >
                      <Text style={[
                        ...
                        { color: customMedData.form === form ? themeColors.primary : themeColors.textSecondary },
                ...
                <Text style={[styles.customMedLabel, { color: themeColors.text }]}>Description/Indication</Text>
                <TextInput
