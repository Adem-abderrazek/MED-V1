  ...
  return (
    <SafeAreaProvider>
      <Stack screenOptions={{ animation: 'none' }}>
        ...
        <Stack.Screen name="doctor/doctor-dashboard" options={{ headerShown: false }} />
        <Stack.Screen name="doctor/doctor-profile" options={{ headerShown: false }} />
        <Stack.Screen name="doctor/edit-profile" options={{ headerShown: false }} />

        {/* Patient Routes */}
        <Stack.Screen name="patient/patient-dashboard" options={{ headerShown: false }} />
        <Stack.Screen name="patient/patient-profile-settings" options={{ headerShown: false }} />
        <Stack.Screen name="patient/patient-edit-profile" options={{ headerShown: false }} />
        <Stack.Screen name="patient/patient-adherence-history" options={{ headerShown: false }} />
        <Stack.Screen name="patient/patient-profile" options={{ headerShown: false }} />
