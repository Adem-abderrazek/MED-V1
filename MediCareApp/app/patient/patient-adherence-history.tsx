          ...
          >
                ...
                >
                  <View style={styles.summaryRow}>
                    ...
                    <View style={styles.summaryItem}>
                      ...
                      <Text style={[styles.summaryValue, { color: COLORS.primary }]}>{stats.totalTaken}</Text>
                    </View>
                    <View style={styles.summaryItem}>
            ...
            <View style={styles.section}>
              <View style={styles.tipsCard}>
                <LinearGradient
                  colors={['rgba(59, 130, 246, 0.1)', 'rgba(59, 130, 246, 0.05)'] as const}
                  style={styles.tipsGradient}
                >
                  <View style={styles.tipsHeader}>
                    <Ionicons name="bulb" size={24} color="#3B82F6" />
                    <Text style={styles.tipsTitle}>Conseils pour améliorer votre observance</Text>
                  </View>
