  ...
  const roles: Role[] = [
    {
      id: 'patient',
      name: t('auth.patient'),
      description: t('auth.patientDesc') || 'Manage my medications and receive reminders',
      icon: 'person'
    },
    {
      id: 'tuteur',
      name: t('auth.tutor'),
      description: t('auth.tutorDesc') || 'Follow treatments of my loved ones',
      icon: 'heart'
    },
    {
      id: 'medecin',
      name: t('auth.doctor'),
      description: t('auth.doctorDesc') || 'Prescribe and follow my patients',
      icon: 'medical'
    }
  ];
        ...
        <View style={styles.modalOverlay}>
          <SafeAreaView style={styles.modalContainer}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{t('auth.userType')}</Text>
              <TouchableOpacity
