...
export default function PatientEditProfileScreen() {
  ...
  const colors = getThemeColors('patient');
  const gradientColors = (colors.background || ['#1a1a2e', '#1B2E1F', '#1D3020']) as [string, string, string];
  const primaryGradient = (colors.gradient || ['#10B981', '#34D399']) as [string, string];
