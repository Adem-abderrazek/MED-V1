...
/**
 * SMS Service for sending SMS via Educanet API
 */
class SMSService {
  constructor() {
    this.baseUrl = config.smsBaseUrl;
   ...
   * @returns {Promise<Object>} SMS send result
   */
  async sendInvitationSMS(phoneNumber, email, password) {
    console.log('───────────────────────────────────────────────────');
   ...
   * @returns {Promise<Object>} SMS send result
   */
  async sendUpdateNotification(phoneNumber, updateType) {
    console.log('───────────────────────────────────────────────────');
